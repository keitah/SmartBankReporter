...
/** Entry point with pre-login account menu. */
public class Launcher {
    ...
    private void addAccount() {
        ...
        boolean ok = service.addAccount(acc, owner);
        System.out.println(ok ? "Аккаунт сохранён." : "Ошибка.");
    }
    ...
    private void chooseAccount() {
        ...
        try {
            ...
            new Menu(service).show(); // переход в меню банка
        } catch (Exception e) {
